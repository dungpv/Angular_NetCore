...
namespace KnowledgeSpace.ViewModels.UnitTest.System
{
    public class RoleCreateRequestValidatorTest
    {
        ...
        [Fact]
        public void Should_Error_Result_When_Miss_RoleId()
        {
        ...
        [Fact]
        public void Should_Error_Result_When_Miss_RoleName()
        {
        ...
        [Fact]
        public void Should_Error_Result_When_Miss_Role_Empty()
        {
            request.Id = string.Empty;
            request.Name = string.Empty;
            var result = validator.Validate(request);
